...
static void insertDefaultAttributeNames(DataPointAttributeNameMap& attributeNames)
{
	attributeNames["apparentTemperature"] = DataPointAttribute::APPARENT_TEMPERATURE;
	attributeNames["apparentTemperatureMax"] = DataPointAttribute::APPARENT_TEMPERATURE_MAX;
	attributeNames["apparentTemperatureMaxTime"] =
	    DataPointAttribute::APPARENT_TEMPERATURE_MAX_TIME;
	attributeNames["apparentTemperatureMin"] = DataPointAttribute::APPARENT_TEMPERATURE_MIN;
	...
	attributeNames["nearestStormBearing"] = DataPointAttribute::NEAREST_STORM_BEARING;
	attributeNames["nearestStormDistance"] = DataPointAttribute::NEAREST_STORM_DISTANCE;
	attributeNames["ozone"] = DataPointAttribute::OZONE;
	attributeNames["pressure"] = DataPointAttribute::PRESSURE;
	attributeNames["precipAccumulation"] = DataPointAttribute::PRECIPITATION_ACCUMULATION;
	attributeNames["precipIntensity"] = DataPointAttribute::PRECIPITATION_INTENSITY;
	attributeNames["precipIntensityMax"] = DataPointAttribute::PRECIPITATION_INTENSITY_MAX;
	attributeNames["precipIntensityMaxTime"] = DataPointAttribute::PRECIPITATION_INTENSITY_MAX_TIME;
	attributeNames["precipProbability"] = DataPointAttribute::PRECIPITATION_PROBABILITY;
	...
	attributeNames["temperatureMaxTime"] = DataPointAttribute::TEMPERATURE_MAX_TIME;
...
std::unique_ptr<DataPointAttributeNameMap> DataPointAttributeDefaultNameMapHolder::pInstance =
    nullptr;
...
std::unique_ptr<DataPointAttributeNameMap> DataPointAttributeDefaultNameMapHolder::createInstance()
{
	std::unique_ptr<DataPointAttributeNameMap> result(
	    new DataPointAttributeNameMap(DataPointAttribute::DataPointAttribute_COUNT));
