...
void SingleDataPointFactory::notifyUVIndex(double uvIndex)
{
	dataPointFactory.notifyUVIndex(uvIndex);
}
...
void SingleDataPointFactory::notifyWindGust(double gust)
{
	dataPointFactory.notifyWindGust(gust);
}
