...
{
	(void)cloudCover; /*Avoid "unused parameter" warning*/
}
void DataPointDetailsListener::notifyDewPoint(double dewPoint)
{
	(void)dewPoint; /*Avoid "unused parameter" warning*/
}
void DataPointDetailsListener::notifyHumidity(double humidity)
{
	(void)humidity; /*Avoid "unused parameter" warning*/
}
...
{
	(void)ozone; /*Avoid "unused parameter" warning*/
}
...
{
	(void)probability; /*Avoid "unused parameter" warning*/
}
...
{
	(void)pressure; /*Avoid "unused parameter" warning*/
}
void DataPointDetailsListener::notifySummary(const std::string& summary)
{
	(void)summary; /*Avoid "unused parameter" warning*/
}
