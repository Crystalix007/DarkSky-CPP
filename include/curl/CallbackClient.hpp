...
/**
 * A class for setting up a handler for making calls to the cURL library and then cleaning up the
 * associated resources on destruction. <b>NOTE:</b> <a
 * href="http://curl.haxx.se/libcurl/c/curl_global_init.html">curl_global_init</a> should have
 * already been called before creating an instance of this class.
 */
class CallbackClient
{
public:
	/**
	 * The callback function To use for processing server responses (see the cURL option "<a
	 *href="http://curl.haxx.se/libcurl/c/CURLOPT_WRITEFUNCTION.html">CURLOPT_WRITEFUNCTION</a>").
	 **/
	 ...
	 * @param[out] pInfoData A pointer to a data structure for storing the information returned.
	 *This must be a pointer to a long, char array, a curl_slist or a double (see the <a
	 *href="http://curl.haxx.se/libcurl/c/curl_easy_getinfo.html#DESCRIPTION">documentation for
	 *curl_easy_getinfo</a>).
	 * @return The cURL response code. If this does not equal CURLE_OK, the information should not
	 *be trusted.
	 **/
	 ...
	 * @param[in] pCallback The callback function To use for processing the response (see the cURL
	 * option "<a
	 * href="http://curl.haxx.se/libcurl/c/CURLOPT_WRITEFUNCTION.html">CURLOPT_WRITEFUNCTION</a>").
...
private:
	/**
	 * The easy handle object for making calls using the cURL library (see <a
	 *href="http://curl.haxx.se/libcurl/c/curl_easy_init.html">the cURL API</a>).
	 **/
	CURL* pCurlHandle;

	/**
	 * The buffer to which cURL error messages are written (see <a
	 *href="http://curl.haxx.se/libcurl/c/CURLOPT_ERRORBUFFER.html">CURLOPT_ERRORBUFFER</a>).
	 **/
